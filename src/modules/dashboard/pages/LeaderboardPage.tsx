          ...
          <Table>
            <TableHead sx={{ bgcolor: 'rgba(0,0,0,0.4)' }}>
              <TableRow>
                ...
                <TableCell sx={{ fontWeight: 800, textAlign: 'center', py: { xs: 1.5, sm: 3 }, px: { xs: 1, sm: 2 }, color: 'text.secondary', textTransform: 'uppercase', letterSpacing: 1, fontSize: { xs: '0.65rem', sm: '0.85rem' } }}>Racha</TableCell>
